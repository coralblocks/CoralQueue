 ...
 *
 * <p>All provided wait strategies throw {@link WaitStrategyInterruptedException} when they observe an interruption.
 * The thread's interrupt status remains set when the exception is thrown.</p>
 */
