...
public class Basics {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int i = 0; i < consumers.length; i++) {
			consumers[i] = new Consumer(demux, i);
		}
		...
		if (sumOfAllBatches == messagesToSend) System.out.println("SUCCESS: The sum of messages from the batches received is correct! => " + messagesToSend);
